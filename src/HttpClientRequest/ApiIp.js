...
//对外提供的服务地址
export const publicIp = process.env.NODE_ENV === 'development' ? 'https://sclmdrpapi.saselomo.com/' : interfaceIp;
export const logoImgIp = process.env.NODE_ENV === 'development' ? 'https://sclmweb.saselomo.com/' : logoImgAddress;
